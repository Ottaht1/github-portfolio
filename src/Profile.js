  ...
  return (
    <div className="profile-container">
      <div className="profile">
        ...
        <p>
          LinkedIn:{" "}
          <a href={`https://www.linkedin.com/in/theresa-ottah/`}>
            Theresa Ottah
          </a>
        </p>
      </div>
      <div className="additional-info">
        ...
        <div className="email-info">
          <p>
            How to reach me{" "}
            <a href="mailto:ottahtheresa@gmail.com">ottahtheresa@gmail.com</a>
          </p>
        </div>
        <p>Connect with me:</p>
        <ul style={{ listStyle: "none" }}>
          <li>
            <a href="https://twitter.com/__theressaa">__theressaa</a>
          </li>
          <li>
            <a href="https://www.linkedin.com/in/theresa-ottah/">
              theresa-ottah
