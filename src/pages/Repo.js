    ...
    <div className="card p-5 main-repo-container">
      <div className="row g-0">
        <div className="col-md-4">
          <img src={data.owner.avatar_url} className="img-fluid rounded-start" alt="repo"></img>
        </div>
        <div className="col-md-8">
          <div className="card-body">
            <h5 className="card-title"><strong>{data.name}</strong></h5>
            <p className="card-text">language: {data.language || "JavaScript"}</p>
            ...
            <p className="card-text">License key: {data.license ? data.license.key : "default"}</p>
            <p className="card-text">License name: {data.license ? data.license.name : "default"}</p>
            <p className="card-text">License node ID: {data.license ? data.license.node_id : "default"}</p>
            <p className="card-text">License SPDX ID: {data.license ? data.license.spdx_id : "default"}</p>
            <p className="card-text">License URL: {data.license ? data.license.url: "default"}</p>
            ...
            <p className="card-text"><small className="text-muted">Stars: {data.stargazers_count}*</small></p>
          </div>
        </div>
      </div>
    </div>
